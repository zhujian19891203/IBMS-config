package com.billJiang.framework.query.pojo;
...
import com.billJiang.framework.query.entity.QueryContext;
import com.billJiang.framework.utils.ConfigurationUtil;
            ...
            for (int i = 0; i < resources.length; i++) {
                ...
                try {
                    QueryContext queryContext = (QueryContext) ConfigurationUtil.parseXMLObject(
                            com.billJiang.framework.query.entity.QueryContext.class, resource);
