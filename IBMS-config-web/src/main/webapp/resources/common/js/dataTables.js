...
CommonTable.prototype.rowSpan=function(tableId, _w_table_colnum_arr) {
	this.table.on("draw", function() {
		for(var i = 0; i < _w_table_colnum_arr.length; i++) {
			_w_table_rowspan("#" + tableId, _w_table_colnum_arr[i]);
		}	
    })
}
