package com.morxeen.framework.interceptor;
...
import com.morxeen.framework.annotation.RefreshCSRFToken;
import com.morxeen.framework.annotation.VerifyCSRFToken;
import com.morxeen.framework.base.pojo.ResultCode;
import com.morxeen.framework.constant.CodeConstant;
import com.morxeen.framework.utils.CSRFTokenUtil;
import com.morxeen.framework.utils.StrUtil;

/**
 * CSRFInterceptor 防止跨站请求伪造拦截器
 *
 * @author morxeen 2016年10月6日 下午8:14:40
 */
