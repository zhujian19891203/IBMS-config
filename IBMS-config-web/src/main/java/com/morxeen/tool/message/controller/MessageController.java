package com.morxeen.tool.message.controller;

import com.morxeen.framework.base.pojo.Result;
import com.morxeen.framework.message.SimpleMailSender;
import com.morxeen.framework.message.entity.SimpleMail;
import com.morxeen.framework.utils.PropertiesUtil;
import com.morxeen.tool.message.service.MessageService;
