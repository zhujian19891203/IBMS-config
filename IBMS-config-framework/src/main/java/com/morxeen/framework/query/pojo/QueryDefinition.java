package com.morxeen.framework.query.pojo;

import com.morxeen.framework.query.entity.Query;
import com.morxeen.framework.query.entity.QueryContext;
import com.morxeen.framework.utils.ConfigurationUtil;
            ...
            for (int i = 0; i < resources.length; i++) {
                ...
                try {
                    QueryContext queryContext = (QueryContext) ConfigurationUtil.parseXMLObject(
                            com.morxeen.framework.query.entity.QueryContext.class, resource);
