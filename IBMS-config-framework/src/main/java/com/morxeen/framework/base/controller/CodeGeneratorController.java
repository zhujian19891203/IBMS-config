...
import com.morxeen.framework.base.pojo.FieldSetting;
import com.morxeen.framework.base.pojo.GenerateSetting;
import com.morxeen.framework.base.pojo.Result;
import com.morxeen.framework.base.service.CodeGeneratorService;
import com.morxeen.framework.query.entity.Query;
import com.morxeen.framework.query.pojo.QueryDefinition;
import com.morxeen.framework.utils.DateUtil;
import com.morxeen.framework.utils.FreeMarkerUtil;
import com.morxeen.framework.utils.PingYinUtil;
...
public class CodeGeneratorController {
    ...
    public Result getXMLContent(String queryId, String className, String modelName) throws ClassNotFoundException {
        ...
        for (Field field : fields) {
            ...
            String classType=field.getType().getName().startsWith("com.morxeen")?String.class.getSimpleName():field.getType().getSimpleName();
